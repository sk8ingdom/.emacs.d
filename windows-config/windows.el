...
(set-default 'tramp-default-method "cygssh")
(defun my/comint-init ()
  (setq comint-process-echoes t))
(add-hook 'comint-mode-hook 'my/comint-init)
(add-to-list
 'directory-abbrev-alist
 '("^/val" . "/cygssh:admin@dominicsurano.com:/share/MD0_DATA/homes/sk8ingdom/"))

;; Requires cygwin installed
(require 'fakecygpty)
(fakecygpty-activate)
...
(eval-after-load "filecache"
                 '(file-cache-add-directory
                   "/cygssh:admin@dominicsurano.com:/share/MD0_DATA/homes/sk8ingdom/"))
